...
## [2.0.0](https://github.com/lorenzofero/revm/compare/revm-primitives-v1.3.0...revm-primitives-v2.0.0) - 2024-01-14
...
- add is_empty_code_hash fn ([#826](https://github.com/lorenzofero/revm/pull/826))
...
- add changed storage slots iter ([#801](https://github.com/lorenzofero/revm/pull/801))
- derive more traits ([#745](https://github.com/lorenzofero/revm/pull/745))

### Fixed
- make revm-primitives no-std with c-kzg feature ([#933](https://github.com/lorenzofero/revm/pull/933))
...
- *(primitives)* Error Primitive Display + Error Implementations ([#770](https://github.com/lorenzofero/revm/pull/770))

### Other
- *(interpreter)* improve enum naming ([#962](https://github.com/lorenzofero/revm/pull/962))
- *(deps)* alloy 0.6 ([#963](https://github.com/lorenzofero/revm/pull/963))
- *(primitives)* improve readability of Env.validate_tx() ([#924](https://github.com/lorenzofero/revm/pull/924))
- *(primitives)* optimize AccountInfo.is_empty() ([#922](https://github.com/lorenzofero/revm/pull/922))
...
- Add docs to `optimism` `InvalidTransaction` errors. ([#884](https://github.com/lorenzofero/revm/pull/884))
- *(deps)* run `cargo update`, bump alloy-primitives ([#880](https://github.com/lorenzofero/revm/pull/880))
- *(primitives)* don't duplicate the SpecId::enabled() logic ([#869](https://github.com/lorenzofero/revm/pull/869))
- simplify use statements ([#864](https://github.com/lorenzofero/revm/pull/864))
- cargo fmt and removed extra newlines ([#860](https://github.com/lorenzofero/revm/pull/860))
...
- *(deps)* make derive-more optional ([#827](https://github.com/lorenzofero/revm/pull/827))
- *(eip4844)* update kzg trusted setup ([#822](https://github.com/lorenzofero/revm/pull/822))
- *(deps)* bump bitflags from 2.4.0 to 2.4.1 ([#803](https://github.com/lorenzofero/revm/pull/803))
- include alloy-primitives std feature ([#788](https://github.com/lorenzofero/revm/pull/788))
- *(primitives)* OptimismFields Docs Cleanup ([#778](https://github.com/lorenzofero/revm/pull/778))
- Remove dead state trait function ([#779](https://github.com/lorenzofero/revm/pull/779))
- Verify account is empty checks ([#780](https://github.com/lorenzofero/revm/pull/780))
- *(primitives)* Clean up the account typs with docs ([#776](https://github.com/lorenzofero/revm/pull/776))
- Use upstream create and create2 implementations ([#775](https://github.com/lorenzofero/revm/pull/775))
- Implement display and error for precompile error ([#777](https://github.com/lorenzofero/revm/pull/777))
- reorder env members ([#771](https://github.com/lorenzofero/revm/pull/771))
